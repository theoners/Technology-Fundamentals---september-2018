...
namespace _01._Ranking
{
    class Program
    {
            ...
            while (input!= "end of submissions")
            {
                ...
                if (contestAndPassword.ContainsKey(contest)&& contestAndPassword[contest]==contestPass)
                {
                    if (!submissions.ContainsKey(name))
                    {
                        ...
                        UserChecher(submissions, contest, name, points);
                }
        ...
        private static void UserChecher(Dictionary<string, Dictionary<string, int>> submissions, string contest,string name, int points)
        {
